...
class ScholarArticleParser(object):
    """
    ScholarArticleParser can parse html5lib document strings obtained from
    ...
    def parse(self, html5lib5lib):
        """
        This method initiates parsing of html5lib content, cleans resulting
        content as needed, and notifies the parser instance of
        resulting instances via the handle_article callback.
        """
        self.soup = BeautifulSoup(html5lib5lib)
    ...
    def _parse_article(self, div):
        ...
        for tag in div:
            ...
            if tag.name == 'div' and self._tag_has_class(tag, 'gs_ri'):
                ...
                # Scholar renders as "CITATION" in the html5lib:
                #
                # <h3 class="gs_rt">
                #   <span class="gs_ctu">
...
class ScholarQuerier(object):
    ...
    with subsequent parsing of the resulting html5lib content.  The
    ...
    def apply_settings(self, settings):
        ...
        # contents of the Settings pane html5lib in order to extract
        # hidden fields before we can compose the query for updating
        # the settings.
        html5lib = self._get_http_response(url=self.GET_SETTINGS_URL,
                                       log_msg='dump of settings form html5lib',
        ...
        # to Google.
        soup = BeautifulSoup(html5lib5lib)
        ...
        html5lib = self._get_http_response(url=self.SET_SETTINGS_URL % urlargs,
                                       log_msg='dump of settings result html5lib',
    ...
    def send_query(self, query):
        ...
        html5lib = self._get_http_response(url=query.get_url(),
                                       log_msg='dump of query response html5lib',
    ...
    def parse(self, html5lib):
        """
        This method allows parsing of provided html5lib content.
        """
        parser = self.Parser(self)
        parser.parse(html5lib)
    ...
    def _get_http_response(self, url, log_msg=None, err_msg=None):
        ...
        try:
            ...
            ScholarUtils.log('debug', 'data:\n' + html5lib.decode('utf-8')) # For Python 3
            ScholarUtils.log('debug', '<<<<' + '-'*68)
